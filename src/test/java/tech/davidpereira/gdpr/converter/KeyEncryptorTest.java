...
public class KeyEncryptorTest {
	...
	public void setUp() {
		...
		ReflectionTestUtils.setField(keyEncryptor, "keyEncryptor",
				new BouncyCastleAesCbcBytesEncryptor(Hex.toHexString("9G0XgFO$*dUu".getBytes()),
						Hex.toHexString("6AzoOXB#qA1L".getBytes()), new FixedIvGenerator("q4oED0a11SWeDV4XrHzfBQ==")));
	}
