...
public class EncryptionConverterTest {
    ...
    public void setUp() {
        ...
        ReflectionTestUtils.setField(stringEncryptor, "bytesEncryptor", new BouncyCastleAesCbcBytesEncryptor(Hex.toHexString("9G0XgFO$*dUu".getBytes()), Hex.toHexString("6AzoOXB#qA1L".getBytes())));
    }
